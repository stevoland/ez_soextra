...
$tpl->setVariable( 'object_parameters', array_merge(array( 'size' => $size, 'align' => $align, 'show_path' => true ), $customs) );
$tpl->setVariable( 'in_oe', true );
