...
<!-- Start editor -->
    ...
    var eZOeAttributeSettings, eZOeGlobalSettings = {ldelim}
        {include uri=concat("design:content/datatype/edit/ezxmltext_soextra.tpl") }
        mode : "none",
        theme : "ez",
        width : '100%',
        language : '{$language}',
        ...
        // stevo - uncommented this line - workaround for cleanup stripping mceCustomTagItem classes 
        cleanup : false,
