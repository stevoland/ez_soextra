...
{if $:tag_name}
    ...
    {foreach $custom_attributes as $custom_attribute}
        ...
        {if and( is_set($embedded_class), ezoe_ini_section( concat('CustomAttribute_', $:tag_name, '_', $embedded_class, '_', $custom_attribute), 'ezoe_attributes.ini' ) )}
            {set $custom_attribute_settings = concat('CustomAttribute_', $:tag_name, '_', $embedded_class, '_', $custom_attribute)}
        {elseif ezoe_ini_section( concat('CustomAttribute_', $:tag_name, '_', $custom_attribute), 'ezoe_attributes.ini' )}
